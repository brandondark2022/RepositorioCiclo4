...
@authenticate('admin')//escribir usuario
export class UsuarioController {
  ...
  async create(
    ...
    let asunto = 'Gracias por sus Comentarios';
    let contenido = `Hola ${usuario.nombre} Bienvenido a la plataforma de Mascota Feliz, Gracias por sus comentarios los tendremos en cuenta para mejorar nuestro servicio`;
